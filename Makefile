...
#    Updated: 2025/08/09 15:19:19 by kaisogai         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PU			= printf_utils
SRCS		= main.c input.c output.c utils.c ft_split.c ft_strjoin.c ft_printf.c $(PU)/ft_putnbr_base.c \
			$(PU)/ft_putnbr_fd.c $(PU)/ft_putuint_fd.c $(PU)/numlen.c $(PU)/print_nums.c \
			$(PU)/print_words.c $(PU)/ft_putchar_fd.c $(PU)/ft_putstr_fd.c
OBJS		= main.o input.o output.o utils.o ft_split.o ft_strjoin.o ft_printf.o $(PU)/ft_putnbr_base.o \
